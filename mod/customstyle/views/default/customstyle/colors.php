...
$cust .= "</div>";
	...
	$cust .= elgg_view('input/submit', array("internalname"=>"submitButton", 'value' => elgg_echo('customstyle:colors:reset')));
	
	$configForm = elgg_view("input/form",array('body' => $cust,'method' => 'post','action' => $vars['url'] . "action/customstyle/savecolors"));
